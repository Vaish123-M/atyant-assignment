  ...
  return (
    <header className="sticky top-0 z-50 border-b border-white/10 bg-[#0B0F2E]/88 backdrop-blur-xl">
      <div className="mx-auto flex w-full max-w-7xl items-center gap-4 px-4 py-4 sm:px-6 lg:px-8">
        ...
        <button
          onClick={onLeadClick}
          className="ml-auto inline-flex items-center gap-2 rounded-full bg-[#FF6B2B] px-5 py-3 text-sm font-semibold text-white shadow-lg shadow-[#FF6B2B]/25 transition hover:scale-[1.03] hover:bg-[#ff7a42]"
        >
          Get Clarity
        </button>
      </div>
